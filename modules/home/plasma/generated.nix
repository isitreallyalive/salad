# auto generated by plasma-manager
{ self, osConfig, ... }:

{
  programs.plasma = self.lib.profile.mkIf osConfig [ "graphical" ] {
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."501b712e-c6fb-4bfe-a816-28f5a9b7d857" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "501b712e-c6fb-4bfe-a816-28f5a9b7d857";
      ...
      "kwinrc"."Desktops"."Id_1" = "9ddaba65-09fc-4021-a44b-a912192c87ba";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/4c943ce7-7233-51dc-a576-44a70f9cf5ae"."tiles" =
